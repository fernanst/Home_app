...
export class AppComponent implements OnInit, OnDestroy {
  ...
  subscribeNewTopic(): void { 
    ...
    this.subscription = this._mqttService.observe(this.topic_status_output).subscribe((message: IMqttMessage) => {
      ...
      else if (_topic == 'home/sensors/temp_planta_baja') {this.temp_planta_baja = this.msg + '\xa0\xa0\xa0ºC';}
      else if (_topic == 'home/sensors/temp_salon') {this.temp_salon = this.msg + '\xa0\xa0\xa0ºC';}
      else if (_topic == 'home/sensors/temp_buhardilla') {this.temp_buhardilla = this.msg + '\xa0\xa0\xa0ºC';}
      else if (_topic == 'home/sensors/temp_exterior') {this.temp_exterior = this.msg + '\xa0\xa0\xa0ºC';}
      else if (_topic == 'home/params/temp_salon_consigna') {this.temp_salon_consigna = this.msg + '\xa0\xa0\xa0ºC';}
